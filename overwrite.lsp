...
(DEFUN shen.byteloop ()
  (HANDLER-BIND
      ((STYLE-WARNING #'MUFFLE-WARNING)
       (COMPILER-WARNING #'MUFFLE-WARNING))
    ;; TODO: is *terminal-io* byte friendly?
    ;; (WITH-OPEN-STREAM
    ;;     (*STANDARD-INPUT* (MAKE-STRING-INPUT-STREAM :ELEMENT-TYPE 'UNSIGNED-BYTE))
    ;;   (WITH-OPEN-STREAM (*STANDARD-OUTPUT* (MAKE-STRING-OUTPUT-STREAM :ELEMENT-TYPE 'UNSIGNED-BYTE))
